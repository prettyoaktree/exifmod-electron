...
EXIFmod ships a small **Lightroom Classic** plugin (**Mac only** for now). Install it from the app’s **Help** menu.
...
This sounds fussy, but it’s a lot calmer than rebuilding edits from scratch.
