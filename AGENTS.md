...
| [docs/user/](docs/user/) (published: [User guide on GitHub Pages](https://prettyoaktree.github.io/exifmod/docs/)) | User guide (source Markdown); [docs/product.md](docs/product.md) is a short pointer to the site and `docs/user/` |
